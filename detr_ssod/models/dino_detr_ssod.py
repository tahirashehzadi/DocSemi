...
class DinoDetrSSOD(MultiSteamDetector):
    ...
    def unsup_loss(
        ...
        **kwargs,
        ...
        print("Input Query Label 1 Shape:", input_query_label_1.size())
        print("Input Query BBox 1 Shape:", input_query_bbox_1.size())
        print("Input Query Label 2 Shape:", input_query_label_2.size())
        print("Input Query BBox 2 Shape:", input_query_bbox_2.size())
