...
from detr_ssod.models.utils import prepare_unsup_cdn
from mmcv.runner.base_module import BaseModule
from mmcv.utils import to_2tuple
from torch.nn.init import normal_
from torchvision.ops.deform_conv import deform_conv2d
from detr_ssod.models.dino_detr_ssod import prepare_unsup_cdn
...
from .attention import EfficientAdditiveAttnetion, FanAttention
...
class DINOTransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model=256, d_ffn=1024,
        ...
        self.self_attn = FanAttention(d_model, n_heads)
...
class DINOTransformerEncoder(nn.Module):
    def __init__(self, encoder_layer, num_layers, 
                       ...
                       num_queries=30, deformable_encoder=True, 
...
class DINOTransformerDecoderLayer(nn.Module):
    def __init__(self, d_model=256, d_ffn=1024,
        ...
        # self.self_attn = EfficientAdditiveAttnetion(in_dims=d_model, token_dim=d_model, num_heads=n_heads) 
        self.dropout2 = nn.Dropout(dropout)
        self.norm2 = nn.LayerNorm(d_model)
