...
if [[ ${TYPE} == 'dino_detr_ssod' ]]; then
    WORK_DIR="work_dirs_publaynet_10%/detr_ssod_dino_detr_r50_coco_120k/${PERCENT}/${FOLD}/"
    mkdir -p $WORK_DIR
...
echo "Training Time: $training_time seconds" >> work_dirs_publaynet_10%.txt
echo "Final GPU Memory Usage: $final_gpu_memory MB" >> work_dirs_ppublaynet_10%.txt
